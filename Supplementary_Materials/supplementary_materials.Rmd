...
- Explain the application and why the application is needed
...
tab |>
  ...
  add_header_above(
    c(" " = 1, "Anticlustering" = 3, "Constrained Anticlustering" = 3, "Random Assignment" = 3)
  )
```
