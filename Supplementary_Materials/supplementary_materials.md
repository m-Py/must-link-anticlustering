...
- reproduce all analyses and Figures (in this case, this includes formulas) reported in the manuscript. See the corresponding .Rmd file---also retrievable from the online repository---for all R code.
...
Basically, it contains a slightly modified/augmented version of the "Results" section in the paper (written before final proof editing, plus the additional Figures). It is fully reproducible via R and R Markdown.
